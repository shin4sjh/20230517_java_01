...
//		//방법2
//		Person[] personArray = new Person[22]; //(new) Person - heap에 4byte 주소 담는 공간 25개 주소 담는걸 만듬
...
//		personArray3[0].setGender("김소똥");
//		personArray3[0] new Person(); //Person name age gender 주소 
//		personArray3[0].setAge[25]
//
//			personArray3[2].setAge[25]
//			personArray3[3].setAge[25]
